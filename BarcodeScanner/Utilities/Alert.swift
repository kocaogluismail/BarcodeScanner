...
struct AlertContext {
    static let invalidDeviceInput = AlertItem(title: "Invalid Device Button", message: "Something is wrong with the camera . We are unable to capture the input.", dismissButton: .default(Text("OK")))
